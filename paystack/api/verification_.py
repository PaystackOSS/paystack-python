...
class Verification(object):
    ...
    @classmethod
    def bvn_match(cls, account_number, bank_code, bvn, **kwargs):  # noqa: E501
        """Match Service  # noqa: E501


        :param account_number: Bank Account Number (required)
        :type account_number: str
        :param bank_code: You can get the list of banks codes by calling the List Bank endpoint (required)
        :type bank_code: int
        :param bvn: 11 digits Bank Verification Number (required)
        :type bvn: str
        :param first_name: Customer's first name
        :type first_name: str
        :param middle_name: Customer's middle name
        ...
        if cls().api_client.client_side_validation and ('account_number' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `account_number` when calling `bvn_match`")  # noqa: E501
        ...
        if cls().api_client.client_side_validation and ('bank_code' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `bank_code` when calling `bvn_match`")  # noqa: E501
        ...
        if cls().api_client.client_side_validation and ('bvn' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `bvn` when calling `bvn_match`")  # noqa: E501
        ...
        if 'middle_name' in local_var_params:
            body_params['middle_name'] = local_var_params['middle_name']
    ...
    @classmethod
    def resolve_bvn(cls, bvn, **kwargs):  # noqa: E501
        ...
        if cls().api_client.client_side_validation and ('bvn' not in local_var_params or  # noqa: E501
                                                        local_var_params['bvn'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `bvn` when calling `resolve_bvn`")  # noqa: E501


        path_params = {}
        if 'bvn' in local_var_params:
            path_params['bvn'] = local_var_params['bvn'] # noqa: E501
